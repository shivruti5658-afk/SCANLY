...
function App() {
  ...
  function capture() {
    ...
    addPage(c.toDataURL("image/jpeg", 0.94));
  }
                      ...
                      filter:
                        current.filter === "Grayscale"
                          ...
                          : current.filter === "B&W"
                            ...
                            : "none",
                      transform: `translate(-${current.crop.x * (100 / current.crop.w)}%,-${current.crop.y * (100 / current.crop.h)}%) scale(${100 / current.crop.w},${100 / current.crop.h}) rotate(${current.rotation}deg)`,
                    }}
                  />
                </div>
